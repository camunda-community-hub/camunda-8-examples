...
@OutboundConnector(name = "Car Connector", type = "com.camunda.consulting:carConnector:1", inputVariables = { "make", "gearbox" })
@ElementTemplate(id = "com.camunda.consulting:carConnector",
    name = "Car Connector",
