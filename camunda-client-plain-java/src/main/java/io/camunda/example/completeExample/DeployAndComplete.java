package io.camunda.example.completeExample;
...
public class DeployAndComplete {
    ...
    public static void main(final String[] args) {
        ...
        try (final CamundaClient client = ClientProvider.createCamundaClient(ClientProvider.AuthMethod.none)) {
            ...
            try (final JobWorker ignored = client.newWorker()
                    .jobType(jobType)
